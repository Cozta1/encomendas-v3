...
@Table(name = "fornecedores", indexes = {
    @Index(name = "idx_fornecedores_equipe_id", columnList = "equipe_id"),
    @Index(name = "idx_fornecedores_nome", columnList = "nome"),
    @Index(name = "idx_fornecedores_email", columnList = "email")
})
